{{-- Ini adalah sebuah halaman HTML untuk form login.  --}}
{{-- Form ini memiliki fitur untuk sign in dengan email dan password, serta social login dengan Facebook, Apple, dan Google. --}}
{{-- Terdapat juga link untuk sign up jika pengguna belum mempunyai akun. --}}
                                ...
                                <form class="form-body row g-3" action="{{ route('signin.process') }}" method="post">
                                    ...
                                    <div class="col-12 col-lg-12 text-center">
                                        <p class="mb-0">Belum mempunyai akun? <a
                                                href="{{ route('signup.index') }}">Sign up</a></p>
                                    </div>
                                </form>
                            </div>
                        </div>
