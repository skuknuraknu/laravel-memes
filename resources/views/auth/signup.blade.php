            ...
            <div class="card shadow-none">
              <div class="card-body">
                <div class="text-center">
                  ...
                  @if ($errors)
                    <span class="bg-danger px-4 py-1 text-white rounded mb-2 {{ $errors->all() ? 'visible' : 'invisible' }}">{{ $errors->first() }}</span>
                  @endif
                </div>
                <form class="form-body row g-3" action="{{ route('signup.process') }}" method="post">
                  ...
                  <div class="col-12">
                    ...
                    <input name="username" type="text" class="form-control" id="inputName" value="{{ old('username') }}">
                  </div>
                  <div class="col-12">
                  ...
                  <div class="col-12 col-lg-12 text-center">
                    <p class="mb-0">Sudah mempunyai akun? <a href="{{ route('signin.index') }}">Sign in</a></p>
                  </div>
                </form>
              </div>
            </div>
