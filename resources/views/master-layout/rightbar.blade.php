                                    ...
                                    <div class="d-flex flex-column gap-6">
                                        ...
                                        <div class="profile-area d-center justify-content-between">
                                            <div class="avatar-item d-flex gap-3 align-items-center">
                                                ...
                                                <div class="info-area">
                                                    <h6 class="m-0"><a href="#" class="smtxt">HAERISKAL KAMIL</a></h6>
                                                </div>
                                            </div>
                                        ...
                                        <div class="profile-area d-center justify-content-between">
                                            <div class="avatar-item d-flex gap-3 align-items-center">
                                                ...
                                                <div class="info-area">
                                                    <h6 class="m-0"><a href="#" class="smtxt">CHAIRUL ICHSAN NUR SANI</a></h6>
                                                </div>
                                            </div>
                                            <div class="btn-group cus-dropdown dropend">
                                                <button type="button" class="dropdown-btn" data-bs-toggle="dropdown" aria-expanded="false">
                                        ...
                                        <div class="profile-area d-center justify-content-between">
                                            <div class="avatar-item d-flex gap-3 align-items-center">
                                                ...
                                                <div class="info-area">
                                                    <h6 class="m-0"><a href="#" class="smtxt">RIJALUL AKHRI</a></h6>
                                                </div>
                                            </div>
                                            <div class="btn-group cus-dropdown dropend">
                                                <button type="button" class="dropdown-btn" data-bs-toggle="dropdown" aria-expanded="false">
                                        ...
                                        <div class="profile-area d-center justify-content-between">
                                            <div class="avatar-item d-flex gap-3 align-items-center">
                                                ...
                                                <div class="info-area">
                                                    <h6 class="m-0"><a href="#" class="smtxt">MUHAMMAD FATHANY</a></h6>
                                                </div>
                                            </div>
                                            <div class="btn-group cus-dropdown dropend">
                                                <button type="button" class="dropdown-btn" data-bs-toggle="dropdown" aria-expanded="false">
